import { View, Text, Pressable, Image, StyleSheet, FlatList, TouchableOpacity, Touchable } from "react-native";
  ...
  return (
   ...
   <Image
        ...
        <Text style={styles.articleDescription}>
          {item.recipeInstructions > 40 ? item.recipeInstructions.slice(0, 40) + "..." : item.recipeInstructions}
        </Text>
